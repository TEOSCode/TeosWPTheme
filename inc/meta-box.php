...
if (! function_exists('orbital_get_meta_fields')) :
	...
	function orbital_get_meta_fields()
	{
		...
		$fields = array(
			array(
				'id' => 'subtitle',
				'label' => __('Subtitle', 'orbital'),
				'type' => 'textarea',
				'default' => '',
			),
			array(
				'id' => 'sidebar',
				'label' => __('Sidebar', 'orbital'),
				'type' => 'checkbox',
				'default' => '1',
			),
			array(
				'id' => 'advertisment',
				'label' => __('Advertisment', 'orbital'),
				'type' => 'checkbox',
				'default' => '1',
			),
			array(
				'id' => 'thumbnail',
				'label' => __('Thumbnail', 'orbital'),
				'type' => 'checkbox',
				'default' => '1',
			),
			array(
				'id' => 'social',
				'label' => __('Social Shares', 'orbital'),
				'type' => 'checkbox',
				'default' => '1',
			),
			array(
				'id' => 'pilar',
				'label' => __('Pilar Page', 'orbital'),
				'type' => 'checkbox',
			),
			array(
				'id' => 'related',
				'label' => __('Related Posts', 'orbital'),
				'type' => 'checkbox',
				'default' => '1',
			),
			array(
				'id' => 'custom-sidebar',
				'label' => __('Custom Sidebar', 'orbital'),
				'type' => 'select',

...
if (! function_exists('orbital_scripts')) :
	...
	function orbital_scripts()
	{
		...
		if (orbital_customize_option('orbital_cookies_active')) {
			wp_enqueue_script('orbital-cookies-js', get_template_directory_uri() . '/assets/js/cookies.min.js', array(), '20190101', true);
		}

		wp_enqueue_script('orbital-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array('jquery'), '20190101', true);
		wp_enqueue_script('orbital-social', get_template_directory_uri() . '/assets/js/social.min.js', false, '20190101', true);
		wp_enqueue_script('orbital-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '20190101', true);
		wp_enqueue_script('orbital-fontawesome', '//use.fontawesome.com/releases/v5.7.2/js/all.js', '20190101', false);
